Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"225x255>", :medium=>"450x450>", :large=>"640x640"}
  ...
  # config.dragonfly_secret = "ac4ca28d7e02343cd5bf552121032eedac4ceab52c67f835"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/maltize/Sites/skaut_jurajski/public/system/refinery/images"
